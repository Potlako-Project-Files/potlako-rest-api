"""
Django settings for potlako_rest_api project.
...
SECRET_KEY = 'django-insecure-h6e8$(3hts%1hv@$h%t2s52+p#7x*=eds2_**3ur4*16$g+i2s'
...
INSTALLED_APPS = [
    ...
    'potlako_rest_api.apps.EdcVisitTrackingAppConfig',
    'potlako_rest_api.apps.EdcMetadataAppConfig',
    'potlako_rest_api.apps.EdcFacilityAppConfig',
...
ROOT_URLCONF = 'potlako_rest_api.urls'
...
WSGI_APPLICATION = 'potlako_rest_api.wsgi.application'
